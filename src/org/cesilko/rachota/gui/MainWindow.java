...
public class MainWindow extends javax.swing.JFrame implements PropertyChangeListener {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (printHelp) {
            ...
            System.out.println("      <language_id> is Java language code e.g. cs, de, en, pt or ru");
            System.out.println("      <country_id> is Java country code e.g. BR, CZ, DE, GB, RU or US");
    ...
    /** Build number. */
    protected static final String build = "#060213";
