        ...
        if (selectedTask != null) {
            ...
            ActionListener addNoteListener = new ActionListener() {
                public void actionPerformed(ActionEvent arg0) {
                    ...
                    Task task = dayView.getTask();
                    if (task != null) {
                        String note = JOptionPane.showInputDialog(null, Translator.getTranslation("MAINWINDOW.NEW_NOTE"), Translator.getTranslation("QUESTION.QUESTION_TITLE"), JOptionPane.QUESTION_MESSAGE);
                        if (note != null) task.addNote(note, true);
                    }
                }
            };
