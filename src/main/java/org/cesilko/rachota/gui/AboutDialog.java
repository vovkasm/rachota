...
public class AboutDialog extends javax.swing.JDialog {
    ...
    public AboutDialog(java.awt.Frame parent, boolean modal) {
        ...
        lbLicense.setCursor(new Cursor(Cursor.HAND_CURSOR));
    ...
    private void initComponents() {
        ...
        lbCopyright.setText(Translator.getTranslation("INFORMATION.COPYRIGHT")
        );
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        lbLicense.setFont(getFont());
        lbLicense.setText("<html><body><a href=\"http://rachota.sourceforge.net/license.txt\">CDDL</a></body></html>");
        ...
        pnInfo.add(lbLicense, gridBagConstraints);

        jLabelText.setFont(getFont());
        jLabelText.setText(Translator.getTranslation("INFORMATION.LICENSE"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        pnInfo.add(jLabelText, gridBagConstraints);
    ...
    private void lbLicenseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbLicenseMouseClicked
        Tools.showURL("http://rachota.sourceforge.net/license.txt");
